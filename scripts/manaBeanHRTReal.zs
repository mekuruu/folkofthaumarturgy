...
mods.thaumcraft.Crucible.addRecipe("PLANTS", <Thaumcraft:ItemManaBean>.withTag({Aspects: [{amount: 1, key: "ordo"}]}), <Thaumcraft:ItemManaBean>, "ordo 8, permutatio 8");
mods.thaumcraft.Crucible.addRecipe("PLANTS", <Thaumcraft:ItemManaBean>.withTag({Aspects: [{amount: 1, key: "terra"}]}), <Thaumcraft:ItemManaBean>, "terra 8, permutatio 8");
mods.thaumcraft.Crucible.addRecipe("PLANTS", <Thaumcraft:ItemManaBean>.withTag({Aspects: [{amount: 1, key: "perditio"}]}), <Thaumcraft:ItemManaBean>, "perditio 8, permutatio 8");
